            ...
            <div className="holder col-md-3  ">
                ...
                <ul className="userdirectoryul">
                            ...
                            <li className="userdirectoryli">
                                ...
                                <img  className="userdirectoryimage" src={user.image.medium_url} alt={user.name}  width="75px" height="75px" border-radius="50%" margin="0 10px 0 0"  float="left" display="block" />
    ...
    return (
        <div className="container">
            ...
            <div className="col" className="emp-profile">
                <h2 className="centered-header">User Directory</h2>
                <hr/>
                <div className="row">
                    {users}
                </div>
